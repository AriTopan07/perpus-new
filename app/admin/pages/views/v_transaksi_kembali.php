                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tgl-pinjam">
                            <section id="new">
                                <form action="pages/function/TransaksiKembali.php?aksi=pengembalian" method="POST">
                                    <div class="form-group">
                                        <label>Judul Buku</label>
                                        <select class="form-control" name="judulBuku" required>
                                            <option selected disabled> -- Silahkan pilih buku yang akan dikembalikan -- </option>
                                            <?php
                                            include "../../config/koneksi.php";

                                            $sql = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE tanggal_pengembalian = ''");
                                            while ($data = mysqli_fetch_array($sql)) {
                                                echo '<option value="' . $data['judul_buku'] . '">' . $data['judul_buku'] . ' | ' . $data['nama_anggota'] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
